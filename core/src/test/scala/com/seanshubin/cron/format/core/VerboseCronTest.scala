...
//      ("1 0 0 * * ? *", "second is 1"),
//      ("2 0 0 * * ? *", "second is 2"),
//      ("2-4 0 0 * * ? *", "second is between 2 and 4"),
//      ("1/5 0 0 * * ? *", "every 5 seconds starting at 1"),
//      ("5/1 0 0 * * ? *", "every second starting at 5"),
//      ("1,2,3 0 0 * * ? *", "second is 1 2 3"),
//      ("* 0 0 * * ? *", "every second"),
//      ("0 3-5 0 * * ? *", "minute is between 3 and 5"),
//      ("0 0 3/1 * * ? *", "every hour starting at 3"),
//      ("0 0 1/3 * * ? *", "every 3 hours starting at 1"),
//      ("0 0 0/3 * * ? *", "every 3 hours"),
//      ("0 0 0 1 * ? *", "day is 1"),
//      ("0 0 0 * 2 ? *", "month is 2"),
//      ("0 0 0 * * ? 2000", "year is 2000"),
//      ("12 0 23 * 11 ? 1978", "second is 12, hour is 23, month is 11, year is 1978"),
//      ("0 23 0 15 * ? *", "minute is 23, day is 15"),
//      ("45 23 8 15 5 ? 2001", "second is 45, minute is 23, hour is 8, day is 15, month is 5, year is 2001"),
//      ("30-45 2/3 * 2,3,7 5 ? 2001-2005", "second is between 30 and 45, every 3 minutes starting at 2, every hour, day is 2 3 7, month is 5, year is between 2001 and 2005"),
//      ("0 0 * * * ? *", "every hour")
    )
